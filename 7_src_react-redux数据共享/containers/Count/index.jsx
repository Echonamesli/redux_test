  ...
  render() {
    ...
    return (
      <div>
        ...
        <h4 style={{color:'skyblue'}}>下面组件的总人数是：{this.props.renshu}</h4>
...
//映射状态
const mapStateToProps = (state) => ({ count: state.he,renshu:state.rens.length });  //现在store管理着多个reducer，所以必须指定你要的是state的he
